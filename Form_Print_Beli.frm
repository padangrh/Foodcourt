...
'            con.Execute ("update tbbarang set jumlah_akhir = jumlah_akhir + " & (Val(item.SubItems(3)) - Val(item.SubItems(4))) & " where kode = '" & item.Text & "'")
'            i = i + 1
'        Loop
'
...
'        Dim bayar As Long
'        bayar = Val(rsbeli!jumlah) * Val(rsbeli!harga)
